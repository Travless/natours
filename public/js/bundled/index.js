...
if (saveSettings) saveSettings.addEventListener("submit", function(e) {
    e.preventDefault();
        ...
        return (0, _tsGeneratorMjsDefault.default)(this, function(_state) {
            switch(_state.label){
                ...
                case 1:
                    res = _state.sent();
                    if (res.data.status === "success") {
                        (0, _alert.showAlert)("success", "Account Data Updated Successfully!");
                        window.setTimeout(function() {
                            location.assign("/me");
                        }, 1500);
                    }
...
},{"@swc/helpers/src/_async_to_generator.mjs":"ei7Qk","@swc/helpers/src/_ts_generator.mjs":"rZ2nd","./alert":"leWEM","axios":"4uFS2","@parcel/transformer-js/src/esmodule-helpers.js":"eQ2NP"}]},["7337i","8SgBN"], "8SgBN", "parcelRequire11c7")
